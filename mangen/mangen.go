...
Simplified version of the main loop:`)
	...
	doc.IndentEnd()
	doc.Indent(7)
	doc.Text("2. If the entire line matches one of the formats, print colored line and go to step 1, otherwise go to step 3")
	doc.IndentEnd()
	doc.Indent(7)
	doc.Text("3. Find and color all patterns in the line and go to step 4")
	doc.IndentEnd()
	doc.Indent(7)
	doc.Text("4. Find and color all words, print colored line and go to step 1")
	doc.IndentEnd()
	doc.EndSection()
