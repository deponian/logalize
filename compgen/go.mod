module github.com/deponian/logalize/compgen

go 1.22.5

toolchain go1.23.0

replace github.com/deponian/logalize => ../

require github.com/deponian/logalize v0.0.0-00010101000000-000000000000
